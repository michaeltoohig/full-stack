...
```bash
STACK_NAME=stag-base-project-com sh ./script-deploy.sh
```
...
Swagger UI: https://base-project.com/swagger/
...
Swagger UI: https://stag.base-project.com/swagger/
...
Swagger UI: http://dev.base-project.com/swagger/

CouchDB: http://dev.base-project.com:5984/_utils
